...
Original file is located at
    https://colab.research.google.com/drive/1-gf-M1GMplanzAv2ZTE-PODX9R7uTVmO
"""
...
class ConvNet(nn.Module):
    ...
    def _make_layers(self, channel, net_width, net_depth, net_norm, net_act, net_pooling, im_size):
        ...
        for d in range(net_depth):
            # Added for MHIST
            if im_size[0] == 224 or im_size[0] == 96: 
                layers += [nn.Conv2d(in_channels, net_width, kernel_size=3, padding=3 if channel == 3 and d == 0 else 1)]
